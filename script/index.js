...
const displayLevelWord = (words) => {
  ...
  words.forEach((word) => {
    ...
    <div class="bg-white rounded-xl shadow-sm text-center py-10 px-5 space-y-4">
        ...
        <p class="font-semibold text-gray-500">Meaning / Pronunciation</p>
        
        <div class="text-2xl font-medium font-bangla ">
          "${word.meaning ? word.meaning : "অর্থ পাওয়া যায় নি"} / ${word.pronunciation ? word.pronunciation : "উচ্চারণ পাওয়া যায়নি"}"
        </div>
        ...
        <div class="flex justify-between items-center pt-4">
          ...
          <button onclick = "pronounceWord('${word.word}')"  class="btn bg-[#1A91FF10] hover:bg-[#1A91FF80] hover:text-white border-none">
